...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
      ...
      <div class="stat-card cursor-pointer" @click="router.push('/records/wrong-book')">
        <div class="flex items-center gap-3 mb-2">
          ...
          <div>
            <div class="text-2xl font-display font-bold text-navy-900 dark:text-white">{{ wrongStore.totalCount }}</div>
            <div class="text-xs text-navy-400">错题待复习</div>
          </div>
        </div>
      </div>
    </div>
